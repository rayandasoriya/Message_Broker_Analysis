...
You can view the [Detailed Report](./c_uparog_DetailedReport.pdf) for more comprehensive information about the project. Also, you can view the [Project Report](./c_uparogReport_IEEE%20Format.pdf) for a concise summary of the comprative analysis of the message brokers. 
